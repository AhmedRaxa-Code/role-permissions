                ...
                <div class="p-6 text-gray-900">
                    <form  action="{{route('art.store')}}"  method="POST">
                        ...
                        <div >
                            ...
                            <div class="mb-3">
                                <input value="{{old('title')}}" placeholder="enter title " type="text" name="title" id="" class="border-gray-300 shadow-sw w-1/2 rounded-lg">
                            </div>
                            @error('title')
                            ...
                            <div class="mb-3">
                                <input value="{{old('author')}}" placeholder="enter author" type="text" name="author" id="" class="border-gray-300 shadow-sw w-1/2 rounded-lg">
                            </div>
                            @error('author')
                            <p class="text-red-400 font-medium">{{$message}}</p>
